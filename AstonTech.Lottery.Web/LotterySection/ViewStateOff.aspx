<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewStateOff.aspx.cs" Inherits="AstonTech.Lottery.Web.LotterySection.ViewStateOff" EnableViewState="false" %>
...
<body>
    <div id="wrapper">
        ...
        <img class="pbheader" src="../Images/PB-Header.jpg" />
          ...
          <p>  This is a test with ViewState= false <asp:Label runat="server" ID="TestingPage" /> </p>
